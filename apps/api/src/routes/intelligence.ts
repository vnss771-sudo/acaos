...
import { getOpportunityTier, calcWinProbability } from '@acaos/backend-core/lib/signalEngine.js'
import type { BuyingStage, OutcomeStage } from '@acaos/backend-core/lib/signalEngine.js'
